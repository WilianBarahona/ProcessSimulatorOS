...
public class Main {
	...
	private static final int TIEMPO_RETARDO_MS=2;

	//Numero de ciclos por segmento de ejecucion
	private static final int CICLOS_X_SEGMENTO=5;
	                 	...
	                 	if(a1.getInfoAdicional()>=0 && a1.getInfoAdicional() < 3) {
	                        if(buscar(a1,segmentos1)==false) {
	                             //No ha entrado al ciclo FOR
							        ...
							        if(instrucciones > 0) {
							        	for(int i=0;i<CICLOS_X_SEGMENTO;i++) {
							        		Thread.sleep(TIEMPO_RETARDO_MS);
							        		if (cantidad==ciclos) {
												i=CICLOS_X_SEGMENTO;//SALIR DEL CICLO WHILE
											}else{
												if (i==(CICLOS_X_SEGMENTO-1)) {
								        			b= a1.getInfoAdicional()+1;
											        a1.setInfoAdicional(b);
												}
								        		a1.setCantidadInstrucciones(instrucciones);
								        		System.out.println((cantidad+1)+". "+ "Prioridad1: "+a1.getIdProceso()+" Instruccion:"+a1.getCantidadInstrucciones());
								        		if (a1.getCantidadInstrucciones()==a1.getInstruccionBloqueo()) {
													...
													i=CICLOS_X_SEGMENTO;//salir del ciclo
    								        ...
    								        if(instrucciones > 0) {
    								        	for(int i=0;i<CICLOS_X_SEGMENTO;i++) {
    								        		...
    								        		if (cantidad==ciclos) {
	    								        		...
	    								        		System.out.println((cantidad+1)+". "+"Prioridad2: "+a2.getIdProceso()+" Instruccion:"+a2.getCantidadInstrucciones());
    	 							        	...
    	 							        	for(int i=0;i<CICLOS_X_SEGMENTO;i++) {
    	 							        		...
    	 							        		if (cantidad==ciclos) {
														...
														if (i==(CICLOS_X_SEGMENTO-1)) {
	    	 							        		...
	    	 							        		System.out.println((cantidad+1)+". "+"Prioridad3: "+a3.getIdProceso()+" Instruccion:"+a3.getCantidadInstrucciones());
					...
					moverTerminadoPrioridad3();
	                 	...
	                 	if(a1.getInfoAdicional()>=0 && a1.getInfoAdicional() < 3) {
	                        ...
	                        for (int i = 0; i < tdaListosPrioridad3.size(); i++) {
		                            if(tdaListosPrioridad3.get(i).getInfoAdicional()>=3){
		                            	if(buscar(tdaListosPrioridad3.get(i),tdaListosPrioridad2)==false){
		                                    int c = tdaListosPrioridad3.get(i).getPrioridad()+1;
		                                    tdaListosPrioridad3.get(i).setPrioridad(c);
    	    		 ...
    	    		 if(!tdaListosPrioridad2.isEmpty()){
    						...
    						moverTerminadoPrioridad2();
    		                 	...
    		                 	if(a2.getInfoAdicional()>=0 && a2.getInfoAdicional() < 3) {
    		                        ...
    		                        for (int i = 0; i < tdaListosPrioridad2.size(); i++) {
    			                            if(tdaListosPrioridad2.get(i).getInfoAdicional()>=3){
    			                            	if(buscar(tdaListosPrioridad2.get(i),tdaListosPrioridad1)==false){
    			                                    int c = tdaListosPrioridad2.get(i).getPrioridad()+1;
    			                                    tdaListosPrioridad2.get(i).setPrioridad(c);
    			                                    agregar(tdaListosPrioridad2.get(i).getIdProceso(),
    			                                    		tdaListosPrioridad2.get(i).getEstadoProceso(),
    	    			 ...
    	    			 if (!tdaListosPrioridad1.isEmpty()) {
    	    				 Procesos a3=tdaListosPrioridad1.remove(contador);
    	        	    		if (tdaListosPrioridad1.size()==1) {
    	        	    			eliminarUltimoPrioridad1();
    	 					 }
    	 					moverTerminadoPrioridad3();
